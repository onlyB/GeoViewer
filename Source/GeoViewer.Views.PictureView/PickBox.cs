    ...
    public class PickBox
    {
        ...
        private void lbl_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            if ((dragging) & (editMode))
            {
                ...
                l = (l < 0) ? 0 : l;
                t = (t < 0) ? 0 : t;
                if (m_control.GetType() == typeof(PictureBox))
                {
                    //Point p = new Point(l, t);
                    //m_control.Location = p;
                    m_control.SetBounds(l, t, w, h);
                    PictureBox picture = (PictureBox)m_control;
                    picture.SizeMode = PictureBoxSizeMode.StretchImage;
                }
                else if (m_control.GetType() == typeof(groupIndicator))
                {
                    m_control.SetBounds(l, t, h, h);
                }
                else m_control.SetBounds(l, t, w, h);
            }
        }
